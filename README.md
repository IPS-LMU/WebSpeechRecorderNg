...
A Speech Recording Tool implemented as an Angular 9 module.
...
Add `"speechrecorderng": "2.10.0"` to the `dependencies` array property in the `package.json` file of your application. Run `npm install` to install the package.
### Module integration
