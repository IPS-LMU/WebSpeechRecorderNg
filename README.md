...
A Speech Recording Tool implemented as an Angular 10 module.
...
Add `"speechrecorderng": "2.12.4"` to the `dependencies` array property in the `package.json` file of your application. Run `npm install` to install the package.
### Module integration
