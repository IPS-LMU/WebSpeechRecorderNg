...
A Speech Recording Tool implemented as an Angular 8 module.
...
Add `"speechrecorderng": "0.26.18"` to the `dependencies` array property in the `package.json` file of your application. Run `npm install` to install the package.
### Module integration
