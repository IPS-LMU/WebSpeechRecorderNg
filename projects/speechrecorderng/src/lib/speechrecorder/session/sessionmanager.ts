...
export class SessionManager implements AfterViewInit,OnDestroy, MediaCaptureListener {
  ...
  playStartSelectionAction: Action<void>|undefined;
  playStopAction: Action<void>|undefined;
  videoPlayer:VideoPlayer|null=null;
  mediaLiveStream:MediaStream|null = null;
  ...
  displayMediaBlob: Blob | null=null;
  ...
  downloadRecording() {
    if (this.displayRecFile) {
      let blob: Blob|null|undefined = this.displayRecFile.blob;
      if (blob) {
  ...
  set displayRecFile(displayRecFile: RecordingFile | null) {
    ...
    if (this._displayRecFile) {
      let mb: Blob|null|undefined = this._displayRecFile.blob;
