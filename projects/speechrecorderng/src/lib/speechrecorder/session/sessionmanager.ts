...
export const enum Status {
  BLOCKED, IDLE,NON_RECORDING,PLAY_PROMPT_PREVIEW,PLAY_PROMPT,STARTING, PRE_RECORDING, RECORDING, POST_REC_STOP, POST_REC_PAUSE, STOPPING_STOP, STOPPING_PAUSE, ERROR
}
