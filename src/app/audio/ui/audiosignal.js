    ...
    (function (audio) {
        ...
        (function (ui) {
            ...
            var AudioSignal = (function () {
                function AudioSignal(container) {
                    var _this = this;
                    this.ce = container;
                    this.wo = null;
                ...
                AudioSignal.prototype.createCanvas = function () {
                ...
                AudioSignal.prototype.init = function () {
                ...
                Object.defineProperty(AudioSignal.prototype, "playFramePosition", {
                    get: function () {
                ...
                AudioSignal.prototype.canvasMousePos = function (c, e) {
                ...
                AudioSignal.prototype.drawCursorPosition = function (e, show) {
                    if (this.cCursor) {
                ...
                AudioSignal.prototype.drawPlayPosition = function () {
                    if (this.cPlaypos) {
                ...
                // }
                AudioSignal.prototype.layoutBounds = function (left, top, offW, offH, redraw) {
                ...
                AudioSignal.prototype.workerFunction = function () {
                    self.onmessage = function (msg) {
                        ...
                        if (audioData) {
                            ...
                            var framesPerPixel = frameLength / w;
                            console.log("Render audio signal: ", w, "x", h);
                            var y = 0;
                            var std = Date.now();
                            var pointsLen = w * chs;
                ...
                AudioSignal.prototype.startRender = function (w, h) {
                    var _this = this;
                    if (this.wo) {
                        this.wo.terminate();
                        this.wo = null;
                ...
                AudioSignal.prototype.drawRendered = function (me) {
                    ...
                    if (this.audioData) {
                        ...
                        for (var ch = 0; ch < me.data.chs; ch++) {
                            ...
                            g.beginPath();
                            g.moveTo(0, y + (chH / 2) + me.data.psMinMax[psMinPos] * chH / 2);
                            ...
                            for (var pii = me.data.w; pii >= 0; pii--) {
                ...
                AudioSignal.prototype.redraw = function () {
                    var g = this.c.getContext("2d");
                    var w = this.c.width;
                    var h = this.c.height;
                    g.clearRect(0, 0, w, h);
                ...
                AudioSignal.prototype.setData = function (audioData) {
                    this.audioData = audioData;
                    this.playFramePosition = 0;
                };
                return AudioSignal;
            }());
            ui.AudioSignal = AudioSignal;
        })(ui = audio.ui || (audio.ui = {}));
    })(audio = ips.audio || (ips.audio = {}));
})(ips || (ips = {}));
//# sourceMappingURL=audiosignal.js.map