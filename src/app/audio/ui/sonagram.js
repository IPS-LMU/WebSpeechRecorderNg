/// <reference path="../../math/dft"/>
/// <reference path="../../dsp/utils"/>
/// <reference path="../../utils/css_utils"/>
var ips;
(function (ips) {
    var audio;
    (function (audio) {
        var ui;
        (function (ui) {
            var DFTFloat32 = ips.math.DFTFloat32;
            var DSPUtils = ips.dsp.DSPUtils;
            var CSSUtils = ips.utils.CSSUtils;
            var Sonagram = (function () {
                function Sonagram(container) {
                    var _this = this;
                    this.ce = container;
                    this.wo = null;
                    ...
                    this.cCursor.addEventListener('mouseover', function (e) {
                        _this.drawCursorPosition(e, true);
                    });
                    this.cCursor.addEventListener('mousemove', function (e) {
                        _this.drawCursorPosition(e, true);
                    }, false);
                    this.cCursor.addEventListener('mouseleave', function (e) {
                        _this.drawCursorPosition(e, false);
                    });
                    this.audioData = null;
                    this.markers = new Array();
                }
                Sonagram.prototype.createCanvas = function () {
                ...
                Sonagram.prototype.init = function () {
                ...
                Object.defineProperty(Sonagram.prototype, "playFramePosition", {
                    get: function () {
                ...
                Sonagram.prototype.canvasMousePos = function (c, e) {
                ...
                Sonagram.prototype.drawCursorPosition = function (e, show) {
                    if (this.cCursor) {
                ...
                Sonagram.prototype.drawPlayPosition = function () {
                    if (this.cPlaypos) {
                ...
                Sonagram.prototype.layout = function () {
                    var offW = this.c.offsetWidth;
                    var offH = this.c.offsetHeight;
                    this.layoutBounds(0, 0, offW, offH, true);
                };
                Sonagram.prototype.layoutBounds = function (left, top, offW, offH, redraw) {
                ...
                Sonagram.prototype.workerFunction = function () {
                        ...
                        if (audioData) {
                            ...
                            for (var ch = 0; ch < chs; ch++) {
                                ...
                                for (var pii = 0; pii < w; pii++) {
                                    framePos = Math.round(p + (pii * framesPerPixel));
                                    // calculate DFT at pixel position
                                    for (var i = 0; i < dftSize; i++) {
                                        var chDat = audioData[framePos + i];
                ...
                Sonagram.prototype.startRender = function (w, h) {
                    var _this = this;
                    if (this.wo) {
                        this.wo.terminate();
                        this.wo = null;
                    ...
                    if (this.audioData && w && h) {
                        ...
                        var start = Date.now();
                        this.wo.onmessage = function (me) {
                            console.log("So rendertime: ", Date.now() - start);
                            _this.drawRendered(me);
                            _this.wo.terminate();
                            _this.wo = null;
                        };
                        if (this.cPlaypos) {
                ...
                Sonagram.prototype.drawRendered = function (me) {
                    if (this.c) {
                        this.c.width = me.data.w;
                        this.c.height = me.data.h;
                        var g = this.c.getContext("2d");
                        var imgDataArr = me.data.imgData;
                ...
                Sonagram.prototype.redraw = function () {
                    var g = this.c.getContext("2d");
                    var w = this.c.width;
                    var h = this.c.height;
                    g.clearRect(0, 0, w, h);
                ...
                Sonagram.prototype.setData = function (audioData) {
            ...
            ui.Sonagram = Sonagram;
        })(ui = audio.ui || (audio.ui = {}));
    })(audio = ips.audio || (ips.audio = {}));
})(ips || (ips = {}));
//# sourceMappingURL=sonagram.js.map